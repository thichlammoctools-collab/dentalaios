...
const imageSelect = `pi.id AS image_id, pi.tenant_id AS image_tenant_id, pi.patient_id AS image_patient_id,
  ...
  pi.description AS image_description, pi.file_id AS image_file_id, pi.thumb_key AS image_thumb_key,
