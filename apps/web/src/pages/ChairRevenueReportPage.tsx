...
export function ChairRevenueReportPage() {
  ...
  if (!canView) return <PageContainer size="reading"><Card><CardHeader><CardTitle>Quyền truy cập cần thiết</CardTitle><CardDescription>Báo cáo doanh thu ghế chỉ dành cho quản trị viên hoặc quản lý.</CardDescription></CardHeader></Card></PageContainer>;
